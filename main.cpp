...
DECLARE_COMPONENT_VERSION("Foo Lyrics","2.0","foo_lyrics open in external notepad txt files with same path and name");


// This will prevent users from renaming your component around (important for proper troubleshooter behaviors) or loading multiple instances of it.
VALIDATE_COMPONENT_FILENAME("foo_lyrics2.dll");
